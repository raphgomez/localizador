...
<title>info_Control_PlanCalidad.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/documentos.PNG" width="37" height="36"/> CONTROL DEL PLAN DE CALIDAD</a>
	  </div>
	...
	nuevaVentana.focus();
	  ...
	  </script><a href="javascript:AbrirCentrado('Formulario_ObjetivoGnal1.php','Pagina','1230','501');" title="Insertar Plan de Calidad"><img src="img/documentos.PNG" width="37" height="36"/>+</a>
	  <script language="JavaScript">
		function AbrirCentrado(Url,NombreVentana,width,height,extras) {
		var largo = width;
		var altura = height;
		...
		</script><a href="javascript:AbrirCentrado('Actualizar_Politica_Sistema.php','Pagina','630','391');"><img src="img/financial-advisor.png" title="Actualizar Politica de Calidad" width="57" height="36"/></a>
	  <a href="filtrar_plancalidad.asp1.php" title="Consultar Plan de Calidad"><img src="img/lupa.png" width="37" height="36"/></a>
	  <a href="Formulario_Seleccion_Proceso5.php" title="Actualizar Objetivos del Plan de Calidad"><img src="img/ARROWS.png" width="37" height="36"/></a>
	  <a href="info_Seguim_indEficacia.asp.php" title="Insertar Indicadores a los Procesos"><img src="img/productividad1.jpg" width="37" height="34"/></a>
	  <a href="info_Control_Procesos.asp.php" title="Insertar Procesos Necesarios"><img src="img/iconfinder_epc_1931213.png" width="37" height="34"/></a>
...
<script src="Highcharts-6.2.0/code/highcharts-3d.js"></script>
...
<div id="container" style="width: 660px; height: 300px"></div>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total de Procesos Planificados'
    },
    subtitle: {
        text: 'Fuente: Plan de Calidad del Sistema de Gestion'
    },
    plotOptions: {
        column: {
            depth: 35
    ...
    series: [{
        ...
        data: [<?php 
				...
				plan_calidad.Proceso,
				Count(plan_calidad.Proceso),
				procesos.Proceso,
				procesos.Siglas,
				procesos.id_proceso,
				plan_calidad.id_plancalidad,
				plan_calidad.fecha,
				plan_calidad.Objetivo_Gnal,
				plan_calidad.Obj_EspNo1,
				plan_calidad.Obj_EspNo2,
				plan_calidad.Obj_EspNo3,
				plan_calidad.Obj_EspNo4,
				plan_calidad.Obj_EspNo5,
				plan_calidad.Obj_EspNo6,
				plan_calidad.Obj_EspNo7,
				plan_calidad.Obj_EspNo8,
				plan_calidad.Obj_EspNo9,
				plan_calidad.Obj_EspNo10,
				plan_calidad.Obj_EspNo11,
				plan_calidad.Obj_EspNo12,
				plan_calidad.Obj_EspNo13,
				plan_calidad.Obj_EspNo14,
				plan_calidad.Obj_EspNo15,
				plan_calidad.Obj_EspNo16,
				plan_calidad.Obj_EspNo17,
				plan_calidad.Obj_EspNo18,
				plan_calidad.Obj_EspNo19,
				plan_calidad.Obj_EspNo20,
				plan_calidad.Obj_EspNo21,
				plan_calidad.Obj_EspNo22,
				plan_calidad.IndicadorNo1,
				plan_calidad.IndicadorNo2,
				plan_calidad.IndicadorNo3,
				plan_calidad.IndicadorNo4,
				plan_calidad.IndicadorNo5,
				plan_calidad.IndicadorNo6,
				plan_calidad.IndicadorNo7,
				plan_calidad.IndicadorNo8,
				plan_calidad.IndicadorNo9,
				plan_calidad.IndicadorNo10,
				plan_calidad.IndicadorNo11,
				plan_calidad.IndicadorNo12,
				plan_calidad.IndicadorNo13,
				plan_calidad.IndicadorNo14,
				plan_calidad.IndicadorNo15,
				plan_calidad.IndicadorNo16,
				plan_calidad.IndicadorNo17,
				plan_calidad.IndicadorNo18,
				plan_calidad.IndicadorNo19,
				plan_calidad.IndicadorNo20,
				plan_calidad.IndicadorNo21,
				plan_calidad.IndicadorNo22,
				plan_calidad.Proceso,
				plan_calidad.nombre_apellido,
				plan_calidad.Sist_Gestion,
				plan_calidad.Observaciones
				FROM
				plan_calidad
				Inner Join procesos ON procesos.id_proceso = plan_calidad.id_proceso
				GROUP BY plan_calidad.Proceso");
				$a = mysql_fetch_array($r);
				for($b=0;$b<mysql_num_rows($r);$b++)
				   {
					 mysql_data_seek($r,$b);
...
<td width="83"><html>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					title: {
						text: 'Cumplimiento de Objetivos del Sistema de Gestión'
					},
					tooltip: {
						formatter: function() {
							return '<b>'+ this.point.name +'</b>: '+ this.y +' Objetivo (s)';
						}
					},
					plotOptions: {
						pie: {
				    ...
				    series: [{
						...
						data: [<?php 
										...
										mysql_select_db("calidad");
										$r = mysql_query("SELECT
										objetivos_especifico.Estado,
										Count(objetivos_especifico.Estado),
										objetivos_especifico.id_ObjEsp
										FROM
										objetivos_especifico
										GROUP BY objetivos_especifico.Estado");
	...
	<body>
		...
		<!-- 3. Add the container -->
		<div id="container12" style="width: 610px; height: 300px; margin: 0 auto"></div>
	</body>
</html></td>
    </tr>
  </table>
...
<td width="83"><html>
  ...
  <script language="JavaScript">
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_plancalidad.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=950 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
...
FROM
plan_calidad
ORDER BY id_plancalidad DESC";  // sentencia sql 
$r = mysql_query($sql); 
...
//echo ' ' . $numero.' registros';  // imprimos en pantalla el n�mero generado 
					...
					if ($numero >=0)
						  {
						 ?><?php echo'<script language="javascript">alert("Hola '.$_SESSION['valid_user'].', usted ya ha planificado en el plan de calidad de QX3M-7.Mangrisk los '.$numero.' procesos declarados en su Sistema de Gestion. Por favor, personalice ahora a las Fichas de Procesos.");</script>';	

						  }
					else 
						  {
							echo '<script language="javascript">alert("! Hola '.$_SESSION['valid_user'].', usted ya ha planificado en el plan de calidad de QX3M-7.Mangrisk los '.$numero.' procesos declarados en su Sistema de Gestion. Por favor, personalice ahora a las Fichas de Procesos. Por favor, determinelos.");</script>';					
							}						
?>
<?php
    } else {
