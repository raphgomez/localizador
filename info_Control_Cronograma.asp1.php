...
<title>info_Control_Cronograma.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="Dashboards.php" title="Menu">☰</a><a href="procesoprimero.php" >❮<a><img src="img/documentos.PNG" width="37" height="36"/> CONTROL DE CRONOGRAMA IMPLEMENTACION</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Formulario_Cronograma.php"title="Insertar actividad a cronograma"> <img src="img/documentos.PNG" width="37" height="36"/>+</a>
	  <a href="Actualizar_Estado_NoConformidades.php" title="Actualizar actividad de cronograma"><img src="img/ARROWS.png" width="37" height="36"/></a>
...
<hr><html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>Cronograma de Implantación</title>
...
`cronograma`.`id_entidad`,
`cronograma`.`fase`,
`cronograma`.`name`,
`cronograma`.`id`,
`cronograma`.`dependency`,
`cronograma`.`parent`,
`cronograma`.`start`,
`cronograma`.`end`,
...
FROM
`cronograma`
WHERE fase='Fase I' AND id_entidad='525'");
			  ...
			  for($b=0;$b<mysql_num_rows($r);$b++)
			   {
				 ...
				 $a = mysql_fetch_array($r);
															...
															start: today + <?php echo ''.$a["start"].'' ;?> * day,
															end: today + <?php echo ''.$a["end"].'' ;?> * day,
															<?php				
															echo ' owner:'.$a["owner"].'},' ;}					
															 ?>]
    },{
...
FROM
`cronograma`
WHERE fase='Fase II' AND id_entidad='525'");
	$a = mysql_fetch_array($r);
...
FROM
`cronograma`
WHERE fase='Fase III' AND id_entidad='525'");
	$a = mysql_fetch_array($r);
...
FROM
`cronograma`
WHERE fase='Fase IV' AND id_entidad='525'");
	$a = mysql_fetch_array($r);
    ...
    title: {
        text: 'Cronograma del Proyecto de Implementación del Sistema de Gestión de Calidad - Diagrama Gantt'
    },
    xAxis: {
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_cronograma.asp1.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=650 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
