...
<p align="right"><table width="974" border="0" bordercolor="#ECE9D8" bgcolor="#33CCFF">
  <script language="JavaScript">
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_catalogo_prod.asp1.php?comentario="+document.getElementById("comentario").value+"' frameborder=700 width=1230 height=750 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
