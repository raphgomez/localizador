...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/documentos.PNG" width="37" height="36"/> CONTROL DE INVENTARIO DE PRODUCTOS EN ALMACEN</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Insertar_ProductosAlmacen.php"title="Insertar Inventario de Productos al Almacen"> <img src="img/documentos.PNG" width="37" height="36"/>+</a>
	  <a href="Formulario_Seleccion_Proceso1.php" title="Insertar Elementos de Procesos"><img src="img/nc.png" width="37" height="36"/></a>
	  <a href="Insertar_GestionPorProceso.php" title="Insertar Gestion Por Proceso"><img src="img/ARROWS.png" width="37" height="36"/></a>
	  <a href="Borrar_Contrato.php" title="Eliminar dato"><img src="img/recycle-bin.png" width="37" height="34"/></a>
	  <a href="Formulario_Seleccion_Proceso3.php" title="Evaluar Eficacia de Proceso"><img src="img/Dark_Off.png" width="37" height="34"/></a>
	  <a href="info_Control_Estadistico_Procesos.asp.php" title="Evaluar Eficacia de Proceso"><img src="img/Dark_Off.png" width="37" height="34"/></a>
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_inventarioalmcen.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=450 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
