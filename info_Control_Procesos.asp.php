...
<div id="container" style="width: 750px; height: 350px; margin: 0 auto"></div>
...
Highcharts.chart('container', {
    chart: {
		...
		backgroundImage: 'img/c_media_RF_main_3-31-2020.jpg', 
        events: {
            load: function () {
                ...
                var ren = this.renderer,
                    ...
                    rightArrow = ['M', 0, 0, 'L', 100, 0, 'L', 95, 5, 'M', 100, 0, 'L', 95, -15],
                    leftArrow = ['M', 100, 0, 'L', 0, 0, 'L', 5, 5, 'M', 0, 0, 'L', 5, -5];

                // Separator, client from service
                ren.path(['M', 150, 40, 'L', 150, 330])
                    .attr({
                        'stroke-width': 2,
                        stroke: 'silver',
                        dashstyle: 'dash',
                ...
                // SaaS client label
                ren.label('Contexto de la  <br/> Organizacion', 32, 3)
                    .attr({
                        fill: colors[0],
                        stroke: 'white',
                        'stroke-width': 2,
					...
					// Arrow from support
                    ren.path(['M', 250, 250, 'L', 250, 185, 'L', 245, 190, 'M', 250, 185, 'L', 255, 190])
                    .attr({
                        'stroke-width': 3,
                        stroke: colors[4]
                    })
					...
					// Arrow from support
                    ren.path(['M', 500, 250, 'L', 500, 185, 'L', 505, 190, 'M', 500, 185, 'L', 505, 190])
                    .attr({
                        'stroke-width': 3,
                        stroke: colors[4]
                    })
                ...
                // Browser label
                ren.label('Necesidades y <br/> Expectativas <br/> de las partes <br/> interesadas', 31, 58)
                    .attr({
                        fill: colors[0],
                        stroke: 'white',
                        'stroke-width': 2,
                ...
                ren.label('Requerimientos', 34, 160)
                    .attr({
                        r: 5,
                        width: 100,
                        fill: colors[4]
                ...
                // Script label
                ren.label('Satisfaccion <br/> de los clientes <br/> Respeto al Medio Ambiente <br/> Seguridad y Salud Laboral', 624, 42)
                    .attr({
                        fill: colors[0],
                        height: 270,
                        stroke: 'white',
    ...
    title: {
        text: 'Alcance del Sistema de Gestión',
        style: {
            color: 'black'
...
//comienza el ciclo
		 ...
		 '<td><div align="justify"><div class="porciento"> '.$a["Total"].'%</div>';
         }
		  ...
		  for($b=0;$b<mysql_num_rows($r);$b++)
           {
			 ...
			 {
     		 echo '<td><div align="justify"><div class="year">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year1">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year8">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year2">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year3">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year4">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
//comienza el ciclo
		...
		if($a["Estado"]="habilitado")
			 {
     		 echo '<td><div align="justify"><div class="year5">Proceso de '.$a["Proceso"].'</div>';
			 }
			else
			 {
...
?>
<?
echo '<td><div align="justify"><div class="year6">Planificacion</div>';
		//echo '<td><div align="justify"><div class="year7"></div>';
?>
<script>
