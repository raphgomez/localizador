...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/icon_presupuesto.png" width="37" height="36"/> CONTROL DE CAPITAL - CASH($)</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Insertar_datoContable.php"title="Insertar datoContable"> <img src="img/icon_presupuesto.png" width="37" height="36"/>+</a>
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_capital.asp1.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=650 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
