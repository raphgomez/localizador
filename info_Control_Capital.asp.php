...
<title>info_Control_Capital.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/documentos.PNG" width="37" height="36"/> CONTROL DE CAPITAL - CASH($)</a>
	  </div>
	...
	<script language="JavaScript">
		...
		</script><a href="javascript:AbrirCentrado('Insertar_datoContable.php','Pagina','630','391');"><img src="img/documentos.PNG" title="Insertar datoContable"" width="37" height="36"/>+</a>
...
<Table width="774" border="0" bordercolor="#ECE9D8" bgcolor="#33CCFF">
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
				    ...
				    title: {
						text: 'Ingresos versus Gastos Personales Periodicos Equivalentes en MN'
					},
				    subtitle: {
					...
					series: [{
						...
						data: [0.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,4000.00,15000.00,38230.00,4000.00,38230.00,4000.00,38000.00]
					},{
						type: 'area',
						name: 'Saldo Efectivo($)',
						pointInterval: 24 * 3600 * 1000,
	...
	<body>
		...
		<!-- 3. Add the container -->
		<div id="container" style="width: 850px; height: 320px; margin: 0 auto"></div>			
	</body>
</html>
</td>
<td width="83"><html>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					title: {
						text: 'Total por Descripciones'
					},
					tooltip: {
						formatter: function() {
							return '<b>'+ this.point.name +'</b>: '+ this.y +' Partida(s)';
						}
					},
					plotOptions: {
						pie: {
				    ...
				    series: [{
						...
						data: [<?php 
										...
										mysql_select_db("calidad");
										$r = mysql_query("SELECT
										`presupuesto_personal`.`Descripcion`,
										Count(`presupuesto_personal`.`Descripcion`),
										`presupuesto_personal`.`id_presupuesto`,
										`presupuesto_personal`.`date`,
										`presupuesto_personal`.`Clasificacion`,
										`presupuesto_personal`.`Descripcion`,
										`presupuesto_personal`.`Elemento`,
										`presupuesto_personal`.`Entrada`,
										`presupuesto_personal`.`Salida`,
										`presupuesto_personal`.`Asignacion`,
										`presupuesto_personal`.`Moneda`,
										`presupuesto_personal`.`Saldo_Efectivo`,
										`presupuesto_personal`.`Observaciones`
										FROM
										`presupuesto_personal`
										GROUP BY `presupuesto_personal`.`Descripcion`");
													  ...
													  for($b=0;$b<mysql_num_rows($r);$b++)
													   {
														 ...
														 $a = mysql_fetch_array($r);
															...
															?>['<?php echo ''.$a["Descripcion"].'';?>',
															    <?php echo ''.$a[COUNT("Descripcion")].'';?>],<?php 
	...
	<body>
		...
		<!-- 3. Add the container -->
		<div id="container12" style="width: 410px; height: 320px; margin: 0 auto"></div>
	</body>
</html></td>
    </tr>
  </table>
...
<td width="83"><html>
  ...
  <script language="JavaScript">
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_capital.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=650 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
...
<div align="right"><div id="result"> 
<img src="../img/Google.png" width="25" height="25" />Google:<input name="text" type="text" id="comentario" onKeyUp="filtrar();">  
</div>
<div id="result"></div>
</html></td>
    </tr>
