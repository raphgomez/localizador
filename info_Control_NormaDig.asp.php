...
<title>info_Control_NormaDig.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/PDF.PNG" width="37" height="32"/> Control de Documentos Normalizativos</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Inser_Norm_Area.php"title="Insertar Documento Normativo"> <img src="img/PDF.PNG" width="37" height="32"/>+</a>
	  <a href="Diagnostico_Normalizativo.php" title="Insertar Elemento Diagnostico"><img src="img/result-right.png" width="37" height="36"/>+</a>
	  <a href="Diagnostico_Normalizativo1.php" title="Insertar Contenido Diagnostico"><img src="img/icon-gestion.png" width="37" height="36"/>+</a>
	  <a href="Formulario_Diagnostico.php" title="Diagnosticar Sistema"><img src="img/compliance-auditor.png" width="37" height="34"/>+</a>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total de Documentos Normativos'
    },
    subtitle: {
        text: 'Fuente: Listado de Control de los Documentos'
    },
    plotOptions: {
        column: {
            depth: 35
    ...
    series: [{
        ...
        data: [<?php 
				...
				normateca.Sist_Gestion,
				Count(normateca.Sist_Gestion)
				FROM
				normateca
				GROUP BY normateca.Sist_Gestion");
				$a = mysql_fetch_array($r);
				for($b=0;$b<mysql_num_rows($r);$b++)
				   {
					 mysql_data_seek($r,$b);
					 $a = mysql_fetch_array($r);
				?>['<?php echo ''.$a["Sist_Gestion"].'';?>',
				<?php echo ''.$a[COUNT("Sist_Gestion")].'';?>],<?php 
				   }?>]
    }]
});
		</script>
...
Highcharts.chart('container12', {
    ...
    title: {
        text: 'Total de Normas por Sistema'
    },
    accessibility: {
        point: {
            valueSuffix: '%'
    ...
    series: [{
        ...
        data: [<?php 
										...
										normateca.Deroga,
										normateca.Esencia,
										normateca.Sist_Norma,
										normateca.ruta_fichero,
										normateca.comentario
										FROM
										normateca
										GROUP BY normateca.Sist_Gestion");
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_normas.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=850 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
