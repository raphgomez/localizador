  ...
  <div style="overflow:auto;">
	...
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  ...
	  <script language="JavaScript">
		...
		</script><a href="javascript:AbrirCentrado('Actualizar_Estado_Documentos.php','Pagina','630','391');"><img src="img/arrows.png" title="Actualizar estado del documento" width="37" height="36"/></a>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total de Información Documentada'
    },
    subtitle: {
        text: 'Fuente: Listado de Control de la Información Documentada'
    },
    plotOptions: {
        column: {
            depth: 35
...
<figure class="highcharts-figure">
    <div id="container12" style="width: 590px; height: 300px; margin: 0 auto"></div></div>
</figure>
...
Highcharts.chart('container12', {
    ...
    title: {
        text: 'Total de la Información Documentada por Estado'
    },
    accessibility: {
        point: {
            valueSuffix: '%'
...
<td width="83"><html>
  ...
  <script language="JavaScript">
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_informacdoc.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=850 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
