...
<title>info_Control_Metrologico.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/metrologico.png" width="37" height="32"/> Control de Recursos Metrológicos</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Inser_MedMedicion_Area.php"title="Insertar Recurso Medicion"> <img src="img/metrologico.png" width="37" height="32"/>+</a>
	  <a href="filtrar_eqmetrologico1.asp.php"title="Inventario Recurso Medicion"> <img src="img/box-3d-open-512.png" width="47" height="42"/>+</a>
	  <a href="Inser_PaisMedMedicion.php" title="Insertar Pais Recurso Medicion"><img src="banderas/bandera-de-cuba.png" width="37" height="36"/>+</a>
	  <a href="Exactitud_MedMedicion.php" title="Insertar Exactitud Recurso Medicion"><img src="img/PDF.PNG" width="37" height="36"/>+</a>
		...
		</script><a href="javascript:AbrirCentrado('Actualizar_Estado_RecMedicion.php','Pagina','630','391');"><img src="img/arrows.png" title="Actualizar Estado de los Recursos Medicion" width="37" height="36"/></a>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total de Recursos de Medición'
    },
    subtitle: {
        text: 'Fuente: Inventario de Medios de Medición'
    },
    plotOptions: {
        column: {
            depth: 35
    ...
    series: [{
        ...
        data: [<?php 
				...
				`metrologia`.`Magnitud`,
				Count(`metrologia`.`Magnitud`),
				`metrologia`.`area`,
				`metrologia`.`NoSerie`,
				`metrologia`.`Modelo`,
				`metrologia`.`MarcaFabric`,
				`metrologia`.`ruta_fichero2`,
				`metrologia`.`NomMedMedic`
				FROM
				`metrologia`
				GROUP BY `metrologia`.`Magnitud`");
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					title: {
						text: 'Total Recursos de Medicion por Estado'
					},
					tooltip: {
						formatter: function() {
							return '<b>'+ this.point.name +'</b>: '+ this.y +' Recurso (s) de medicion';
						}
					},
					plotOptions: {
						pie: {
				    ...
				    series: [{
						...
						mysql_select_db("calidad");
						$r = mysql_query("SELECT
						exactitud_metrolog.Estado_exactitud,
						Count(exactitud_metrolog.Estado_exactitud),
						exactitud_metrolog.id,
						exactitud_metrolog.`date`,
						exactitud_metrolog.date2,
						exactitud_metrolog.NomMedMedic,
						exactitud_metrolog.Unidad,
						exactitud_metrolog.Comp_1,
						exactitud_metrolog.Comp_2,
						exactitud_metrolog.Comp_3,
						exactitud_metrolog.Comp_4,
						exactitud_metrolog.Comp_5,
						exactitud_metrolog.Comp_6,
						exactitud_metrolog.Total,
						exactitud_metrolog.observaciones,
						exactitud_metrolog.Rango_equipo,
						exactitud_metrolog.Res_Sens,
						exactitud_metrolog.Error_eq,
						exactitud_metrolog.Error_Req,
						exactitud_metrolog.Error_Max_Req,
						exactitud_metrolog.IncertidumbreA,
						exactitud_metrolog.IncertidumbreB,
						exactitud_metrolog.IncertidumbreExp,
						exactitud_metrolog.Estado_exactitud,
						exactitud_metrolog.ruta_fichero6,
						exactitud_metrolog.evidencia_documental
						FROM
						exactitud_metrolog
						GROUP BY exactitud_metrolog.Estado_exactitud");
													  ...
													  for($b=0;$b<mysql_num_rows($r);$b++)
													   {
														 ...
														 $a = mysql_fetch_array($r);
															...
															?>['<?php echo ''.$a["Estado_exactitud"].'';?>',
															    <?php echo ''.$a[COUNT("Estado_exactitud")].'';?>],<?php 
...
<td width="83"><html>
  ...
  <script language="JavaScript">
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_eqmetrologico.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=750 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
