...
<title>info_Control_DocumDigExt.asp.php</title>
<meta charset="utf-8">
...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="index2.php" title="Menu">☰</a>❮<a><img src="img/59dd83353b8e6ade996ff4cdd8f99ad0.PNG" width="37" height="32"/>Documentos Legales</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Inser_DocLegal_Area.php" title="Insertar Documento Legal"> <img src="img/59dd83353b8e6ade996ff4cdd8f99ad0.PNG" width="27" height="36"/>+</a>
	  <a href="filtrar_documentolegal1.asp.php" title="Filtrar Documentos Legales"><img src="img/nc.png" width="37" height="36"/></a>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Total de Documentos Legales'
    },
    subtitle: {
    ...
    series: [{
        ...
        data: [<?php 
				...
				`doc_legal`.`Area`,
				Count(`doc_legal`.`Area`),
				`doc_legal`.`id`,
				`doc_legal`.`date`,
				`doc_legal`.`Tipo_Doc`,
				`doc_legal`.`Area`,
				`doc_legal`.`ministerio`,
				`doc_legal`.`Esencia2`,
				`doc_legal`.`ruta_fichero`,
				`doc_legal`.`comentario`
				FROM
				`doc_legal`
				GROUP BY `doc_legal`.`Area`");
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_documentolegal.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=850 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
