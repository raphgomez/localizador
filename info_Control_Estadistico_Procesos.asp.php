...
<div style="position: fixed; top: 0pt;" class="w3-card-2 topnav" id="topnav">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:55%;overflow:hidden;height:44px">
      <a href="Dashboard.php" title="Menu">☰</a>❮<a><img src="img/documentos.PNG" width="37" height="36"/> CONTROL ESTADISTICO DE PROCESOS</a>
	  </div>
	<div class="w3-bar w3-right" style="width:45%;overflow:hidden;height:44px;">
	  <a href="Analisis_Capacidad_Proceso.php"title="Hacer Analisis de Capacidad del Proceso"> <img src="img/PDF.PNG" width="37" height="36"/>+</a>
...
<script src="Highcharts-6.2.0/code/modules/histogram-bellcurve.js"></script>
<div id="container88" style="width: 650px; height: 360px; margin: 0 auto"></div>
...
Highcharts.chart('container88', {
    title: {
        text: 'Distribucion de Frecuencias'
    },
    xAxis: [{
        title: { text: 'Data' },
        alignTicks: false
...
<script src="Highcharts-6.2.0/code/highcharts.js"></script>
<script src="Highcharts-6.2.0/code/modules/histogram-bellcurve.js"></script>
<div id="container12" style="width: 650px; height: 360px; margin: 0 auto"></div>
...
Highcharts.chart('container12', {
    ...
    title: {
        text: 'Curva de Distribucion Normal'
    },
...
function filtrar(){
  document.getElementById("result").innerHTML = "<iframe src='filtrar_procesos1.asp.php?comentario="+document.getElementById("comentario").value+"' frameborder=1270 width=1270 height=450 scroll=100>";
}
</script>
  <div align="center">
  <body onLoad="filtrar();">
